...
class ImguiD3D8Device : IDirect3DDevice8 {
public:
    IDirect3DDevice8* device;

    ImguiD3D8Device() : ImguiD3D8Device(nullptr) {}
    ImguiD3D8Device(IDirect3DDevice8* device) : device(device) {
        device->AddRef();
    }
    virtual ~ImguiD3D8Device() {
        device->Release();
    }
